...
Inicialmente, deve conseguir a identificação do dispositivo que está em PC+1 -- PC vale 0, PC+1 é 1, e a UC pede o valor contido nesse endereço para a memória (obtém 2).
Então, faz uma operação de leitura de entrada e saída, passando o identificador 2.
