...
2. **escrita** (recebe `1 [org] 2 [end] [val]`): [end] é o endereço onde se quer escrever, [val] é o valor a escrever. A memória substitui o valor que está nessa posição pelo novo valor fornecido, e envia uma resposta contendo somente um 0. (envia `[org] 1 0`)
